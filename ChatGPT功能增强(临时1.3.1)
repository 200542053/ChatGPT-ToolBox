// ==UserScript==
// @name         ChatGPT功能增强(临时1.3.1)
// @namespace    https://greasyfork.org/zh-CN/scripts/456901-chatgpt%E5%8A%9F%E8%83%BD%E5%A2%9E%E5%BC%BA
// @version      1.3.0.1
// @description  [从Github上拉下来的临时版，等待捈荼大佬更新greasyfork]目前功能：1.关闭数据监管；2.会话导入导出；3.高负载限制解锁；4.绕过'Access denied'
// @author       bigemon; 捈荼
// @match        https://chat.openai.com/chat
// @match        https://chat.openai.com/chat/*
// @match        https://chat.openai.com/auth/login
// @match        https://chat.openai.com/chat?model=gpt-4
// @match        https://chat.openai.com/chat*
...
function unblockAccessDenied() {
  ...
  `;
    ...
    _alert("赛博工具娘v1.3.1脚本已启用。本工具由ChatGPT在指导下生成~\r\n\r\n更新:\r\n\r\n1. 追加绕过'Access denied'的功能\r\n2. 修复前端错误");
}
